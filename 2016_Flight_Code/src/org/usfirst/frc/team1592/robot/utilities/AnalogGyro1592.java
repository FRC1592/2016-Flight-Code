 ...
 */
public class AnalogGyro1592 extends GyroBase implements Gyro, PIDSource, LiveWindowSendable {
...
//  private PIDSourceType m_pidSource;
   ...
   */
  public AnalogGyro1592(int channel) {
   ...
   */
  public AnalogGyro1592(AnalogInput channel) {
    m_analog = channel;
    if (m_analog == null) {
   ...
   */
  public AnalogGyro1592(int channel, int center, double offset) {
   ...
   * @param offset Preset uncalibrated value to use as the gyro offset.
   */
  public AnalogGyro1592(AnalogInput channel, int center, double offset) {
    m_analog = channel;
    if (m_analog == null) {
      throw new NullPointerException("AnalogInput supplied to Gyro constructor is null");
    }
