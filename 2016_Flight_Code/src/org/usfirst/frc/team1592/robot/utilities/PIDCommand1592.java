 ...
 */
public abstract class PIDCommand1592 extends Command implements Sendable
{
	 ...
	 */
	public PIDCommand1592(String name, double p, double i, double d)
	{
		super(name);
	 ...
	 */
	public PIDCommand1592(String name, double p, double i, double d, double period)
	{
		super(name);
	 ...
	 * @param d the derivative value
	 */
	public PIDCommand1592(double p, double i, double d)
	{
		controller = new PIDController1592(p, i, d, source, output);
	}
	 ...
	 * @param period the time (in seconds) between calculations
	 */
	public PIDCommand1592(double p, double i, double d, double period)
	{
		controller = new PIDController1592(p, i, d, source, output, period);
	}
	 ...
	 */
	protected PIDController1592 getPIDController()
	{
		return controller;
	}
