...
public class CalculateDistanceVision extends Command
{
	double dist;
	double armCmd_Deg;
	double wristCmd_Deg;
	...
	public CalculateDistanceVision(double armCmd_Deg)
	{
		requires(Robot.arm);
	...
	protected void initialize()
	{
		...
		dist = SmartDashboard.getNumber("Distance_Old", 0);
//		DriverStation.reportError("Dist "+dist+"\r\n", false);
		wristCmd_Deg = (.0011*Math.pow(dist, 2d)) - (0.3465*dist) + 65;
//		DriverStation.reportError("Ang "+wristCmd_Deg+"\r\n", false);
